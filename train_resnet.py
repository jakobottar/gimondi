...
import dataset
from models import ResNetSegmentationNet
import trainer
import utils
...
if __name__=='__main__':
    ...
    dataloader = utils.SemiSupervisedDataLoader(sup_dataloader, unsup_dataloader)

    net = ResNetSegmentationNet(sup_loss=nn.CrossEntropyLoss(), unsup_loss=nn.MSELoss())
    optimizer = torch.optim.AdamW(net.parameters(), lr=0.01)

    net_trainer = trainer.Trainer(net, dataloader, test_dataloader, optimizer, FLAGS.n_gpus)
